...
<div class="container">
    ...
    <div class="my_post_list">
        ...
        >
            <a
                class="my_atag_none my_mr_sm_1"
                href="/user/{{postRespDto.userId}}/post?page={{postRespDto.prev}}"
            >
            ...
            <a
                class="my_atag_none"
                href="/user/{{postRespDto.userId}}/post?page={{.}}"
            >
            ...
            <a
                class="my_atag_none my_ml_sm_1"
                href="/user/{{postRespDto.userId}}/post?page={{postRespDto.next}}"
            >
